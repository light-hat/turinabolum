        ...
        <CardContent class="space-y-4">
          <form @submit.prevent="handleRegister" class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-2">
                <Label for="first_name" class="text-sm font-medium text-slate-700 dark:text-slate-300 ">First name</Label>
                <Input
                  id="first_name"
              ...
              <div class="space-y-2">
                <Label for="last_name" class="text-sm font-medium text-slate-700 dark:text-slate-300 ">Last name</Label>
                <Input
                  id="last_name"
